...
export function GameCard({ game, onRSVP, onViewDetails, isJoined = false, showLocation = true }: GameCardProps) {
                ...
                {game.playersJoined.length > 0 && (
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        {game.playersJoined.length > 3 && (
                            <span className="text-xs text-muted-foreground">+{game.playersJoined.length - 3} more</span>
                        )}
                    </div>
                )}
